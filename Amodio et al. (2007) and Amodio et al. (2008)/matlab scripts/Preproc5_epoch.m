...
for i = 1:length(files)
    ...
    %re-reference data to average reference and add back A1 to be included in
    ...
    %% epoch data into correct Go and No/Go for N2 
    %baseline correction based on Amodio et al 2007
    ...
    for m = 1:length(forERP)
        ...
        forERP(m).AC = struct('Clean_Epochs_Mask', Clean_Epochs_Mask);
