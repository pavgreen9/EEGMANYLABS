...
for i = 1%:length(files)
    ...
    while true
        ...
        % IC Label
        EEG = iclabel(EEG);
        pop_viewprops(EEG, 0, [1:29-length(tag)], {'freqrange', [2 80]}, {}, 1, 'ICLabel');

        answ = input('Press 0 to close all GUI and save, else will proceed to removal of components):');
